            ...
            <ul>
            	...
            	<c:choose>	
                	<c:when test="${empty sessionScope.workerUser}">
            			<li><a href="/admin/admin_login_form"style="text-decoration: none;">관리자 로그인</a></li>
            		</c:when>
            		<c:otherwise>
                		<li><a href="/member/logout"style="text-decoration: none;">관리자 로그아웃</a></li> 
                	</c:otherwise>
            	</c:choose>
            	</c:if>
                ...
                <c:choose>
                	<c:when test="${empty sessionScope.loginUser.id}">
                		<li><a href="/member/login" style="text-decoration: none;">로그인</a></li> 
               	 	</c:when>
                	<c:otherwise>
                		<li><a href="/member/logout"style="text-decoration: none;">로그아웃</a></li> 
                	</c:otherwise>
