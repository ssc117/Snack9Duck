...
<head>
<meta charset="UTF-8">
<link rel="stylesheet" type="text/css" href="/resources/css/policy.css">
...
<div id="privacy">
    <p id="title"> 서비스 이용약관</p>
    <p><span style="font-size:14px">&nbsp;</span> </p>
    <p id="bold">제1조(목적)</p>
    <p>이 약관은 업체 회사(전자상거래 사업자)가 운영하는 업체 사이버 몰(이하 "몰"이라 한다)에서 제공하는
        인터넷 관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리의무 및 책임사항을 규정함을 목적으로 합니다.
        *「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다」</p>
    <p><span style="font-size:14px">&nbsp;</span> </p>
    
    <p id="bold">제2조(정의)</p>
    <p>①"몰" 이란 업체 회사가 재화 또는 용역(이하 "재화등"이라 함)을 이용자에게 제공하기 위하여 컴퓨터등
        정보통신설비를 이용하여 재화등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도
        사용합니다.
    ...
    <p><span style="font-size:14px">&nbsp;</span> </p>
    <p id="bold"> 제3조(약관등의 명시와 설명 및 개정)</p>
    <p>
        ① "몰"은 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함),
        전화번호, 모사전송번호, 전자우편주소, 사업자등록번호, 통신판매업신고번호, 개인정보관리책임자등을 이용자가 쉽게 알 수 있도록
        업체 사이버몰의 초기 서비스화면(전면)에 게시합니다.
        ...
        화면에 그 적용일자 7일이전부터 적용일자 전일까지 공지합니다. 다만, 이용자에게 불리하게 약관내용을 변경하는 경우에는
        ...
        고 그 이전에 이미 체결된 계약에 대해서는 개정전의 약관조항이 그대로 적용됩니다.
        다만 이미 계약을 체결한 이용자가 개정약관 조항의 적용을 받기를 원하는 뜻을 제3항에 의한 개정약관의 공지기간내에
        '몰"에 송신하여 "몰"의 동의를 받은 경우에는 개정약관 조항이 적용됩니다.
        ⑥ 이 약관에서 정하지 아니한 사항과 이 약관의 해석에 관하여는 전자상거래등에서의소비자보호
        에관한법률, 약관의규제등에관한법률, 공정거래위원회가 정하는 전자상거래등에서의 소비자보호지침 및 관계법령 또는 상관례에 따릅니다.</p>
    <p><span style="font-size:14px">&nbsp;</span> </p>
    <p id="bold">제4조(서비스의 제공 및 변경)</p>
    <p>① "몰"은 다음과 같은 업무를 수행합니다.
        ...
        다만, "몰"이 보상기준 등을 고지하지 아니한 경우에는 이용자들의 마일리지
        또는 적립금 등을 "몰"에서 통용되는 통화가치에 상응하는 현물 또는 현금으로 이용자에게 지급합니다.</p>
    <p><span style="font-size:14px">&nbsp;</span> </p>
    <p id="bold">제5조(서비스의 중단)</p>
    ...
    <p><span style="font-size:14px">&nbsp;</span> </p>
    <p id="bold">제7조(회원 탈퇴 및 자격 상실 등)</p>
    <p>
        ...
        ③ "몰"이 회원 자격을 제한정지 시킨 후, 동일한 행위가 2회이상 반복되거나 30일이내에 그 사유
    ...
    <p><span style="font-size:14px">&nbsp;</span> </p>
    <p id="bold">제8조(회원에 대한 통지)</p>
    <p>
        ① "몰"이 회원에 대한 통지를 하는 경우, 회원이 "몰"과 미리 약정하여 지정한 전자우편 주소로
        할 수 있습니다.
        ② "몰"은 불특정다수 회원에 대한 통지의 경우 1주일이상 "몰" 게시판에 게시함으로서 개별 통지
        에 갈음할 수 있습니다. 다만, 회원 본인의 거래와 관련하여 중대한 영향을 미치는 사항에 대하여는 개별통지를 합니다.</p>
    <p><span style="font-size:14px">&nbsp;</span> </p>
    <p id="bold">제9조(구매신청)</p>
    <p>"몰"이용자는 "몰"상에서 다음 또는 이와 유사한 방법에 의하여 구매를 신청하며, "몰"은 이용자가
        ...
        6. 결제방법의 선택</p>
    <p><span style="font-size:14px">&nbsp;</span> </p>
    <p id="bold">제10조(계약의 성립)</p>
    <p>① "몰"은 제9조와 같은 구매신청에 대하여 다음 각호에 해당하면 승낙하지 않을 수 있습니다. 다
...
수 있습니다. 단, "몰"은 이용자의 지급방법에 대하여 재화 등의 대금에 어떠한 명목의 수수료도 추가하여 징수할 수 없습니다.
    ...
    <p><span style="font-size:14px">&nbsp;</span> </p>
    <p id="bold">제12조(수신확인통지구매신청 변경 및 취소)</p>
    <p>① "몰"은 이용자의 구매신청이 있는 경우 이용자에게 수신확인통지를 합니다.
        ② 수신확인통지를 받은 이용자는 의사표시의 불일치등이 있는 경우에는 수신확인통지를 받은 후 즉시
        구매신청 변경 및 취소를 요청할 수 있고"몰"은 배송전에 이용자의 요청이 있는 경우에는 지체없이 그 요청에 따라 처리하여야 합니다.
        다만 이미 대금을 지불한 경우에는 제15조의 청약철회 등에 관한 규정에 따릅니다.</p>
    <p>제13조(재화등의 공급)<span style="font-size:14px">&nbsp;</span> </p>
    <p id="bold">제13조(재화등의 공급)</p>
    <p>① "몰"은 이용자와 재화등의 공급시기에 관하여 별도의 약정이 없는 이상,
        이용자가 청약을 한 날부터 7일 이내에 재화 등을 배송할 수 있도록 주문제작, 포장 등 기타의 필요한 조치를 취합니다.
        ...
        명시합니다. 만약 "몰"이 약정 배송기간을 초과한 경우에는 그로 인한 이용자의 손해를 배상하여야 합니다.
        다만 "몰"이 고의과실이 없음을 입증한 경우에는 그러하지 아니합니다.</p>
    <p><span style="font-size:14px">&nbsp;</span> </p>
    <p id="bold">제14조(환급)</p>
    <p>"몰"은 이용자가 구매신청한 재화등이 품절 등의 사유로 인도 또는 제공을 할 수 없을 때에는 지체없이 그 사유를 이용자에게
        통지하고 사전에 재화 등의 대금을 받은 경우에는 대금을 받은 날부터 2영업일 이내에 환급하거나 환급에 필요한 조치를 취합니다.</p>
    <p><span style="font-size:14px">&nbsp;</span> </p>
    <p id="bold">제15조(청약철회 등)</p>
    ...
    <p><span style="font-size:14px">&nbsp;</span> </p>
    <p id="bold">제16조(청약철회 등의 효과)</p>
    <p>① "몰"은 이용자로부터 재화 등을 반환받은 경우 3영업일 이내에 이미 지급받은 재화등의 대금을 환급합니다.
        이 경우 "몰"이 이용자에게 재화등의 환급을 지연한 때에는 그 지연기간에 대하여 공정거래위원회가 정하여 고시하는
        ...
        명확하게 표시합니다.</p>
    <p><span style="font-size:14px">&nbsp;</span> </p>
    <p id="bold">제17조(개인정보보호)</p>
    <p>①"몰"은 이용자의 정보수집시 구매계약 이행에 필요한 최소한의 정보를 수집합니다. 다음 사항을
        ...
        ③제공된 개인정보는 당해 이용자의 동의없이 목적외의 이용이나 제3자에게 제공할 수 없으며, 이에 대한 모든 책임은 “몰”이 집니다.
        다만, 다음의 경우에는 예외로 합니다.
        ...
        정보통신망이용촉진 및 정보보호등에관한법률 제22조 제2항이 규정한 사항을 미리 명시하거나 고지해야 하며
        ...
        달성한 때에는 당해 개인정보를 지체없이 파기합니다.</p>
    <p><span style="font-size:14px">&nbsp;</span> </p>
    <p id="bold">제18조("몰"의 의무)</p>
    <p>① "몰"은 법령과 이 약관이 금지하거나 공서양속에 반하는 행위를 하지 않으며 이 약관이 정하는 바에 따라 지속적이고,
        안정적으로 재화용역을 제공하는데 최선을 다하여야 합니다.
    ...
    <p><span style="font-size:14px">&nbsp;</span> </p>
    <p id="bold">제19조(회원의 ID 및 비밀번호에 대한 의무)</p>
    <p>① 제17조의 경우를 제외한 ID와 비밀번호에 관한 관리책임은 회원에게 있습니다.
        ② 회원은 자신의 ID 및 비밀번호를 제3자에게 이용하게 해서는 안됩니다.
        ③ 회원이 자신의 ID 및 비밀번호를 도난당하거나 제3자가 사용하고 있음을 인지한 경우에는
        바로 "몰"에 통보하고 "몰"의 안내가 있는 경우에는 그에 따라야 합니다.</p>
    <p><span style="font-size:14px">&nbsp;</span> </p>
    <p id="bold">제20조(이용자의 의무)</p>
    ...
    <p><span style="font-size:14px">&nbsp;</span> </p>
    <p id="bold">제21조(연결"몰"과 피연결"몰" 간의 관계)</p>
    <p>① 상위 "몰"과 하위 "몰"이 하이퍼 링크(예: 하이퍼 링크의 대상에는 문자, 그림 및 동화상 등이
        ...
        경우에는 그 거래에 대한 보증책임을 지지 않습니다.<span style="font-size:14px">&nbsp;</span> </p>
    <p id="bold">제22조(저작권의 귀속 및 이용제한)</p>
    ...
    <p id="bold">제24조(재판권 및 준거법)</p>
    <p>①"몰"과 이용자간에 발생한 전자상거래 분쟁에 관한 소송은 제소 당시의 이용자의 주소에 의하고, 주소가 없는 경우에는
    ...
    <p><span style="font-size:14px">&nbsp;</span> </p>
    <p id="bold" style="color: rgb(73, 73, 73);">본 약관은 2022년 09월 21일부터 적용됩니다.</p>
