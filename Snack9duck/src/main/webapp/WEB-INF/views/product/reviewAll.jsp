	...
	<c:otherwise>
		...
		<div class="cart-table-content-prodInfo">
			<div class="cart-table-content-prodInfo-img">
				<a class="cart-table-content-prodInfo-a" href="#"><!-- 해당 제품 상품상세페이지로 이동 -->
					<img src="/snack9duck/${product.image}" />
				</a>
			</div>
	...
	<div class="pageForAll-table-body">
		...
		<div class="pageForAll-table-row">
			...
			<div class="pageForAll-table-row-detail pdl20">
				<input type="hidden" id="rnum" name="rnum" value="${reviewList.rnum}">
				${reviewList.content}<!-- 리뷰 상세로 이동 -->
			</div>
