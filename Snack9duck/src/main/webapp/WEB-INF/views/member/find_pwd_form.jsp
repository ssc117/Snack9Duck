...
<div class="frame find_form">
    <article class="card-body" style="max-width: 400px; margin: auto;">
        ...
        <div class="form-group input-group fg-x400">
            ...
            <form method="post" action="/member/find_pwd_form">
	          
	          	<div >
	            <input name="id" class="find_member"  type="text" placeholder="아이디">
	            </div>
	            <span style="font-size: 13px;">회원가입 시 등록한 아이디를 입력해주세요.</span>
	          	<div style="margin-top: 30px;">
	            <input name="name" class="find_member"  type="text" placeholder="이름">
	            </div> 
	           ...
	           <select name="phone1" id="hp1" class="reg_input" required>
	            ...
	            <div style="margin-top:30px">
	                <button class="find_button" type="submit">  비밀번호 찾기</button>   
	            </div> 
	            <c:if test = "${result == 0 }">
    ...
    $(".find_button").click(function(){
    	...
    	//find_id_form.submit();
    	$("#find_pwd_form").attr("action", "/member/find_pwd_form");
