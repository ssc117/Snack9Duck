...
<script>
	...
	<div id="content">
		...
		<div id="wrap">
			<div id="container" class="">
				<div id="editor"></div>
				<form action="/order/order_submit"
										...
										<ul class="order-info-box">
											...
											<li><span class="head">배송지 정보</span> <!-- s : 단일 배송 -->
												<div id="delivery-tab-view1"
													...
													style="display: block">
													<ul class="order-info-detail info-order">
														<li>이름 :${orderList.name}</li>
														<li>연락처 : ${orderList.phone1}-${orderList.phone2}-${orderList.phone3}</li>
														<li>주소 :(${orderList.zip_code})${orderList.addr1}${orderList.addr2}${orderList.addr3}</li>
														<li>요청사항 : <input type="text" name="request" id="request" placeholder="배송메시지를 입력해 주세요."> </li>
	...
	<input type="hidden" id="oseq" value="${orderList[0].oseq}">
	<script>
    ...
    function requestPay() {
      ...
      IMP.request_pay({ // param
          ...
          if (rsp.success) {
        	  var request = document.order_payment_form.request("reqeust");
        	  
        	  alert("구매가 완료되었습니다.");
        	  document.order_payment_form.action = "/order/order_submit";
