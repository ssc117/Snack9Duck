				...
				<tr>
					...
					<c:choose>
						...
						<c:when test="${orderList.result eq 3}">
							<td style="color:black; text-decoration: none;">배송중</td>
						</c:when>
						<c:when test="${orderList.result eq 4}">
							<td style="color:black; text-decoration: none;">배송완료</td>
						</c:when>
					</c:choose>
					<td><a href="/admin/order/admin_order_Update?eventno=${eventList.eventno}" style="text-decoration: none;">수정</a></td>
