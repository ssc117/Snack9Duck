        ...
        <div id="event_form">
        	...
        	<div id="event">
				...
				<div class="form_tit">
                  ...
                  <div class="form_input">
                    <input type="file" name="file" id="file" style="border:0 solid black; width: 700px; font-size: 18px;"/>
                  </div>
                </div>
                ...
                <div class="form_tit">
                  ...
                  <div class="form_input">
                    <input type="file" name="file2" id="file2" style="border:0 solid black; width: 700px; font-size: 18px;"/>
                  </div>
                </div>
              </div>
...
<script>
function Checkform() {
	var kindRegExp =/^[0-9]{1,1}$/;
	var priceRegExp =/^[0-9]{1,1}$/;
	var fileRegExp;
